    ...
    <div className="flex justify-center items-center min-h-screen bg-white px-4">
      <div className="bg-white shadow-md rounded-lg flex w-[1200px] overflow-hidden">
        ...
        <div className="w-1/2 p-14 flex flex-col justify-center">
          ...
          <h2 className="text-5xl font-bold text-gray-900 text-center">Create an account</h2>
          ...
          <p className="text-base text-gray-500 mt-6 text-center">
            Already have an account? <Link href="/auth/signin" className="text-[#0E1629] font-medium">Sign in</Link>
          </p>
        </div>
      </div>
    </div>
